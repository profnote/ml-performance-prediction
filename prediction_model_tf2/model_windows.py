...
class Model:
    ...
    def train(self, traindata, trainlabel, testdata, testlabel, num_train_steps):
        ...
        try:
            os.mkdir(os.path.join(os.getcwd(),'checkpoints', '%s' %self.model_name))
        except:
            pass
        ...
        with tf.compat.v1.Session() as sess:
            ...
            ckpt = tf.train.get_checkpoint_state(os.path.dirname(os.path.join('checkpoints', '%s', 'checkpoint' %self.model_name)))
            print("PASS!")
